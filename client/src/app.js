...
const property5 = new Property("Income Tax", "Income Tax","tax",null,[200],null)
const property6 = new Property("Kings Cross Station", "Kings Cross","station",200,[25,50,100,200],null)
const property7 = new Property("The Angel, Islington","The Angel, Islington","sky_blue",100,[6,12,30,90,270,400,550],50)
...
const property15 = new Property("Northumberland Avenue","N'th'land Av","pink",160,[12,24,60,180,500,700,900],100)
const property16 = new Property("Marylebone Station", "Marylebone","station",200,[25,50,100,200],null)
const property17 = new Property("Bow Street", "Bow St","orange",180,[14,28,70,200,550,750,950],100)
...
const property25 = new Property("Trafalgar Square", "Trafalgar Sq","red",240,[20,40,100,300,750,925,1100],150)
const property26 = new Property("Fenchurch Street Station", "Fenchurch St","station",200,[25,50,100,200],null)
const property27 = new Property("Leicester Square", "Leicester Sq","yellow",260,[22,44,110,330,800,975,1150],150)
...
const property35 = new Property("Bond Street", "Bond St","green",320,[28,56,150,450,1000,1200,1400],200)
const property36 = new Property("Liverpool Street Station", "Liverpool St","station",200,[25,50,100,200],null)
const property37 = new Property("Chance","Chance","bonus chance",null,[null],null)
const property38 = new Property("Park Lane", "Park Lane","dark_blue",350,[35,70,175,500,1100,1300,1500],200)
const property39 = new Property("Super Tax", "Super Tax","tax",null,[100],null)
const property40 = new Property("Mayfair", "Mayfair","dark_blue",400,[50,100,200,600,1400,1700,2000],200)
